...
export type AppContextType = EditableAppContext &
  CommentsOptions & {
    ...
    dispatchAction: <T extends ActionType | SyncActionType>(
      action: T,
      data: Parameters<(typeof Actions & typeof SyncActions)[T]>[0] extends { data: any }
        ? Parameters<(typeof Actions & typeof SyncActions)[T]>[0]['data']
        : any,
    ) => T extends ActionType ? Promise<void> : void;
